import { HangulNumberOptions, HanNumber, NativeNumberOption, SinoNumberOption } from './HanNumber';
...
export abstract class HangulNumber extends HanNumber {
  ...
  static create<T extends HangulNumberOptions>(
    type: T['type'],
    option: T['option']
  ): NativeNumber | SinoNumber {
