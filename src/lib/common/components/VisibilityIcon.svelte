...
<button type="button" on:click title={visible ? 'hide hangul input' : 'show hangul input'} style={`width: ${size}`}>
  <!-- https://mui.com/material-ui/material-icons/?query=visibility -->
  {#if visible}
